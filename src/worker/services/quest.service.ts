...
/**
 * Archive a quest (set hidden to true)
 */
async archiveQuest(questId: string): Promise<Quest> {
  return this.updateQuest(questId, { hidden: true });
}
